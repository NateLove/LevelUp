...
public class AppListAdapter extends BaseAdapter {
   ...
   public View getView(int position, View convertView, ViewGroup parent) {
      ...
      if(convertView == null) {
         ...
         holder.mTitle.setTextColor(Globals.textColor);
         holder.mIcon = (ImageView) convertView.findViewById(R.id.appicon);
         holder.mLayout = (LinearLayout) convertView.findViewById(R.id.appLayout);
         holder.mLayout.setBackgroundColor(Globals.backgroundColor);
