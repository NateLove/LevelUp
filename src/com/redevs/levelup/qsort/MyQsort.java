package com.redevs.levelup.qsort;

import java.util.*;

import com.redevs.levelup.global.Friend;
import com.redevs.levelup.tabs.App;
...
public class MyQsort {
	...
	public static List<App> sortArrayList(List<App> list)
	{
		App[] test = new App[list.size()];
		list.toArray(test);
		MyQsort.qsort(test, 0, list.size() - 1, 0);
		//list = new List<App>(Arrays.asList(test));
