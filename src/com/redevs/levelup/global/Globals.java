...
public class Globals {
	...
	public static boolean colorsHaveChangedFriends = true;
	public static boolean colorsHaveChangedGames = true;
	public static String about = "Welcome to LevelUp! \n\n     This is app is designed to extend Social Networking to Android Gaming. With this app the user can share all game playing activity, by choice, to all of Facebook and Twitter. You can also see what games your friends have been playing, allowing you to take your Android Gaming to new a level by exploring new games. We hope you enjoy the pancakes!  ";
